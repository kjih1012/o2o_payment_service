...
<!-- 상단 시작 { -->
	...
	<div id="hd">
		<div id="hd_wrapper">
			<div id="logo">
				<a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="logo"></a>
			</div>
		</div>
	</div>
	<div id="gnb">
		<div id="gnb_wrapper">
			<ul>
				...
				<li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=ourwork">OUR WORK</a></li>
				<li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice">NOTICE</a></li>
				<li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=reference">REFERENCE</a></li>
				<li><a href="<?php echo G5_BBS_URL ?>/content.php?co_id=Donation#">DONATION</a></li>
			</ul>
		</div>
	</div>
<!-- } 상단 끝 -->
