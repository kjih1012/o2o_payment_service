    ...
    <div>
        <ul>
            <li>
                ...
                <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="id">
                <span id="msg_mb_id"></span>
                <span class="frm_info">Only alphabetic characters, numbers, _ can be entered.<br>Please enter at least 3 characters.</span>
            </li>
            <li>
                <label for="reg_mb_password">PASSWORD</label>
                <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="frm_input half_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="password">
            </li>
            <li>
                <label for="reg_mb_password_re" class="sound_only">CONFIRM PASSWORD</label>
                <input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="frm_input half_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="confirm password">
            </li>
        </ul>
    </div>
    ...
    <div class="tbl_frm01 tbl_wrap">
        <ul>
            <li>
                ...
                <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="name">
                <?php
            ...
            <?php if ($req_nick) {  ?>
            <li>
                <label for="reg_mb_nick">NICKNAME</label>
                
                    <input type="hidden" name="mb_nick_default" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>">
                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace  half_input" size="10" maxlength="20" placeholder="nickname">
                    <span id="msg_mb_nick"></span>
                    <span class="frm_info">
                        Only Korean, English, and numeric characters can be entered without spaces (two or more Korean characters, four or more English characters).<br>
If you change your nickname, you won't be able to change it within the next <?php echo (int)$config['cf_nick_modify'] ?>days.
                    </span>
...
-->
    ...
    <input type="submit" value="<?php echo $w==''?'SIGN UP':'MODIFY
'; ?>" id="btn_submit" class="btn_submit" accesskey="s">
</div>
</div>
