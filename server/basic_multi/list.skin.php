...
//$file=G5_DATA_PATH."/file/multi_upload/2130706433_SNvcMxWH_0ba22338d8632cf33e6e8fafa5ae5a67931a914a.JPG";
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($admin_href) { ?>
			<li><button id="board_setup"class="btn_admin btn"><i class='fa fa-gear' aria-hidden='true'></i> 설정</button></li>
			<li><a href="<?php echo $admin_href ?>" class="btn_admin btn"><i class="fa fa-user-circle" aria-hidden="true"></i> 관리자</a></li><?php } ?>
...
<div class="m_layer  pop_layer  hidden">
	<div class="pop_inbox"></div>
	<div class="pop_close">창&nbsp;닫&nbsp;기</div>
</div>

<?php if ($is_checkbox) { ?>
<script>
var bsp = "<?php echo $board_skin_url; ?>";
$(document).ready(function() {

	// 관리자 설정 팝업
    $('#board_setup').click(function () {
		layer_popup('800','500'); // layer_pop(팝업창가로크기, 팝업창높이);
		$("div.pop_inbox").load(bsp+"/multi/setup.php?bo_table="+g5_bo_table);
	});
