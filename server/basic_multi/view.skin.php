...
$file_cnt = count($view['file']);
set_session("multi_view_image",$bo_table."_off");
...
<script src="<?php echo $board_skin_url; ?>/multi/_function.js"></script>
...
$(function() {
	...
	var file_cnt = "<?php echo $file_cnt; ?>";
	if(file_cnt > 0) {
		// 첨부 파일이 존재시..
		carPictures("off");
	}
